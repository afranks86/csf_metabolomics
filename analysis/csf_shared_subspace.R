...
plot((1:nvec[1])/nvec[1], svd(residuals_list[[1]]/sqrt(nvec[1]))$d^2, pch=19, cex=0.75, type="l", col=1,
     ylim=c(0, 1))
...
abline(h=0, v=0)
legend("topright", legend=unique(types)[1:3], lty=1, lwd=2, col=contourColors,
